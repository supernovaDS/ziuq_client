          ...
          <div className="w-full space-y-6">
            ...
            <div className="space-y-4 max-h-87.5 overflow-y-auto pr-2 custom-scrollbar">
              ...
              {results.map((res, index) => (
                <div key={index} className="flex flex-col p-5 rounded-2xl bg-surface-container-low/50 hover:bg-[#192540] border border-outline-variant/20 transition-colors duration-300">
          ...
          <div className="mt-10 w-full flex flex-col gap-3">
            {hasNextRound ? (
              ...
              <button 
                ...
                className="w-full group/btn relative py-3.5 bg-linear-to-tr from-secondary to-secondary-fixed hover:to-[#72f5ff] text-on-secondary-fixed rounded-full font-black text-lg tracking-tight shadow-[0_5px_20px_rgba(0,227,253,0.2)] transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden active:scale-95"
              >
                <span className="relative z-10 uppercase tracking-widest">Calculate Final Score</span>
                <span className="material-symbols-outlined relative z-10 text-[1.25rem] group-hover/btn:translate-x-1.5 transition-transform duration-300">
            ...
            <button 
              onClick={onExit} 
              className="mt-2 text-xs font-bold text-on-surface-variant hover:text-error transition-colors uppercase tracking-widest flex items-center justify-center gap-1 py-2"
            >
